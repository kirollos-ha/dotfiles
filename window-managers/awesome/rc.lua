...
local function pick_random_wallpaper()
    -- eccove na closure, belle
    local wallpaper_dir = "/home/big/Pictures/Sfondi/" 
...
local function set_random_wallpaper(s)
    gears.wallpaper.maximized(pick_random_wallpaper(),s)
end
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function() awful.spawn("amixer -q set Master toggle") end,
              {description = "mute on/off", group = "volume"}),
    -- sweet sweet rice
    awful.key({"Mod1", "Control"}, "w", function() set_random_wallpaper() end,
